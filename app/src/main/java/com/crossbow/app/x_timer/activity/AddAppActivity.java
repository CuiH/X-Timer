...
import com.crossbow.app.x_timer.adapter.AppInfoAdapter;
...
public class AddAppActivity extends AppCompatActivity {
    ...
    private List<AddAppAppInfo> appList;
    ...
    public void initCustomAppList() {
        ...
        for (int i = 0;i < packages.size(); i++) {
            ...
            AddAppAppInfo tmpInfo;
            if (selectedList.contains(packageName)) {
                tmpInfo = new AddAppAppInfo(packageName, appName, appIcon, true);
                selectedCount = selectedCount+1;
            } else {
                tmpInfo = new AddAppAppInfo(packageName, appName, appIcon, false);
            }
            appList.add(tmpInfo);
        }
    }
    ...
    private void handleListView() {
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                AddAppAppInfo nowApp = appList.get(position);
    ...
    private void handleButton() {
        ...
        ok.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                // add new list
                for (AddAppAppInfo nowApp: appList) {
                    if (nowApp.getSelected()) {
